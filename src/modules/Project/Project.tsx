  ...
  const menu = useMemo(
    () => (
      ...
      >
        <MenuItem
          onClick={async () => {
            history.push(`/projects/detail/${selectedItem?._id}`);
            handleCloseMenu();
          }}
        >
                    ...
                    <div className="card-body">
                      ...
                      <div className="leader">
                        ...
                        <div className="text-muted">
                          <img
                            className="avatar"
                            src={item.approverInfo.avatar}
                          />
                          <ListItemText
                            primary={`${item.approverInfo?.firstName} ${item.approverInfo?.lastName}`}
                            secondary={`${item.approverInfo?.email}`}
                          />
                        </div>
                      </div>
                      <div className="team">
